                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-inverse-collapse">
                        <ul class="nav nav-icons">
                            ...
                            <li><a href="activity.html"><i class="menu-icon icon-bullhorn"></i>Management of accounts </a>
                            </li>
                            <li><a href="message.html"><i class="menu-icon icon-inbox"></i>Add Shipping <b class="label green pull-right">
                                11</b> </a></li>
                            <li><a href="task.html"><i class="menu-icon icon-tasks"></i>Settings <b class="label orange pull-right">
                                19</b> </a></li>
                        </ul>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    <button class="btn btn-warning">Yet to be paid</button>
                                                </td>
                                                <td>
                                                    asdfghk
                                                </td>
