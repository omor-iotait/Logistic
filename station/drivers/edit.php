...
VALUES('$username','$password','$email','$name','$contact_number','$vehicle_number','$vehicle_type','$zone','$uploaded_image','$country','$state','$city','$post_code','$address')";
    ...
    if ($con->query($query) === TRUE) {
        ...
        header("location:" . BASE_URL . "station/drivers/view.php");
        exit(0);
    } else {
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="username" id="username"
                                               placeholder="Enter driver's name" value="<?php echo @$row['username'];?>" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                               placeholder="Enter driver's email" value="<?php echo @$row['email'];?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="name">Name</label>
                                        <input type="text" class="form-control" name="name" id="name"
                                               placeholder="Enter driver's name" value="<?php echo @$row['name'];?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="contact_number">Contact number</label>
                                        <input type="text" class="form-control" name="contact_number"
                                               id="contact_number" placeholder="Enter drivers contact number" value="<?php echo @$row['contact_number'];?>"required>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="vehicle_number"
                                                   id="vehicle_number" placeholder="Enter vehicle's number" value="<?php echo @$row['vehicle_number'];?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="vehicle_type" name="vehicle_type"
                                                ...
                                                <option selected disabled><?php echo @$row['vehicle_type'];?></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="zone"
                                               id="zone" placeholder="Enter zone name" value="<?php echo @$row['zone'];?>" required>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="country" id="country"
                                                   placeholder="country" value="<?php echo @$row['country'];?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="state" id="state"
                                                   placeholder="state"  value="<?php echo @$row['state'];?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="post_code" id="post_code"
                                                   placeholder="postal code" value="<?php echo @$row['post_code'];?>" required>
                                        </div>
